...
// user_id
    if(isset($_GET['get_id'])){
        ...
        $get_product->execute([$_GET['user_id']]);
...
<head>
    ...
    <title>Medicure-checkout page</title>
</head>
    ...
    <div class="main">
        ...
        <section class="checkout">
            <div class="title">
                ...
                <h1>checkout summary</h1>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque blanditiis nam alias aperiam, error
                    excepturi et placeat iure eius a.</p>
            </div>
            <div class="row">
                <form method="post">
                        ...
                        <div class="box">
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="pincode" required maxlength="6"
                                    placeholder="Enter your pincode" min="0" max="999999" class="input">
                            </div>
                        </div>
                    </div>
                ...
                <div class="summary">
                    ...
                    <div class="box-container">
                        <?php
                            ...
                            ?>
                        <div class="flex">
                            <img src="img/<?php echo $fetch_get['image'];?>" class="image">
                            <div>
                                <h3 class="name">
                                    <?php echo $fetch_get['name'];?>
                                </h3>
                                <p class="price">
                                    <?php echo $fetch_get['price'];?>/-
                                </p>
                            </div>
                        </div>
                        <?php
                        ...
                        ?>
                        <div class="flex">
                            <img src="img/<?php echo $fetch_product['image'];?>">
                            <div>
                                <h3 class="name">
                                    <?php echo $fetch_product['name'];?>
                                </h3>
                                <p class="price">
                                    <?php echo $fetch_product['price'];?> X
